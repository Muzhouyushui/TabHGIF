...
def get_args():
    ...
    # parser.add_argument("--data_scv", type=str,
    #                     help="Path to the full Bank Marketing CSV file (; separated)")
    parser.add_argument("--train_csv", type=str,
                        default=CREDIT_DATA,
                        help="Path to the full Bank Marketing CSV file (; separated)")
    ...
    parser.add_argument("--hidden_dim", type=int, default=90, help="HyperGCN hidden layer dimension")
    parser.add_argument("--depth", type=int, default=2, help="HyperGCN network depth")
    ...
    # Column classification for the Bank dataset
